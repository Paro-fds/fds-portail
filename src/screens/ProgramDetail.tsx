...
import { ArrowLeft, CheckCircle, Download, Calendar, Mail, FileText, Send, Bolt, Cpu, RadioTower, Terminal } from "lucide-react";
  ...
  if (!program) {
    return (
      <div className="flex flex-col items-center justify-center p-xl">
        <h1 className="text-h1">Programme inconnu</h1>
    ...
    <div className="max-w-7xl mx-auto px-4 py-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
        ...
        <div className="md:col-span-8 flex flex-col gap-6">
          <section className="bg-surface border border-outline-variant p-8 flex flex-col justify-center">
            <div className="inline-flex items-center gap-1.5 bg-surface-container-high px-3 py-1 rounded-full w-max mb-6 border border-outline-variant">
              <CheckCircle className="w-3.5 h-3.5 text-primary fill-current" />
        ...
        <aside className="md:col-span-4 flex flex-col gap-6">
          <div className="bg-surface-container-high rounded-none overflow-hidden min-h-[300px] border border-outline-variant relative group">
            <img 
            ...
            <div className="absolute bottom-0 left-0 p-6 w-full">
              <span className="fds-label-caps text-white/80 block mb-1">Laboratoire Appliqué</span>
              <p className="text-sm text-white italic">Équipements de pointe pour la conception de systèmes embarqués.</p>
            </div>
          </div>
          ...
          <section className="bg-primary-container p-8 text-on-primary flex flex-col gap-6 relative overflow-hidden">
            <div className="relative z-10">
              <div className="flex items-center gap-2 mb-3">
                ...
                <span className="fds-label-caps text-surface-container-highest">Session Automne</span>
              </div>
